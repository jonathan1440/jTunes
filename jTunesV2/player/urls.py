...
urlpatterns = [
    ...
    path('genres/<int:artist_id>/', views.view_genre, name='view genre'),
    path('genres/edit/', views.new_genre, name='new genre'),
    path('genres/edit/<int:artist_id>/', views.edit_genre, name='edit genre'),
    path('genres/delete/<int:artist_id>/', views.delete_genre, name='delete genre'),
]
